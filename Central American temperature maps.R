works_with_R("3.0.2", animint="2014.3.19", maps="2.3.6",
             lubridate="1.3.3", plyr="1.8.1")
load("climate.RData")
...
viz <- list(duration=list(time2=3000),
            ...
            source="https://github.com/tdhock/animint-paper/blob/3145684d8a164d8d576fc00a078a72083b4d5389/examples/climate/viz.R"
            )
